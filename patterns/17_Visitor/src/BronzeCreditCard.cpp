...
BronzeCreditCard::BronzeCreditCard(float init_value) {
    this->current_saving = init_value;
}

float BronzeCreditCard::getSavings() {
    return this->current_saving;
}

bool BronzeCreditCard::pay(float amount) {
...
float BronzeCreditCard::visit(ICreditVisitor* visitor) {
